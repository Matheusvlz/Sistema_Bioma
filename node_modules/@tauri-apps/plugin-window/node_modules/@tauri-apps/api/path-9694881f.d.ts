...
type path_BaseDirectory = BaseDirectory;
...
declare const path_tempDir: typeof tempDir;
declare namespace path {
  export {
    ...
    path_tempDir as tempDir,
  };
}

export { resolve as A, BaseDirectory as B, normalize as C, join as D, dirname as E, extname as F, basename as G, isAbsolute as H, tempDir as I, appConfigDir as a, appDataDir as b, appLocalDataDir as c, appCacheDir as d, appLogDir as e, audioDir as f, cacheDir as g, configDir as h, dataDir as i, desktopDir as j, documentDir as k, downloadDir as l, executableDir as m, fontDir as n, homeDir as o, path as p, localDataDir as q, pictureDir as r, publicDir as s, resourceDir as t, resolveResource as u, runtimeDir as v, templateDir as w, videoDir as x, sep as y, delimiter as z };
