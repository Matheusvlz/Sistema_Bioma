...
interface QualidadeScreenProps {
  projetos: Projeto[];
...
export const QualidadeScreen = memo<QualidadeScreenProps>(({ projetos, estatisticas }) => {
  return (
    <>
      {/* Cards de Estatísticas para Qualidade */}
      <div style={{
        display: 'grid',
      ...
      {/* Análises Recentes para Qualidade */}
      <div style={modernCardStyle}>
        <div style={{ display: 'flex', alignItems: 'center', marginBottom: '1.5rem' }}>
          <Award size={24} color="#166534" style={{ marginRight: '0.75rem' }} />
          <h2 style={{ fontSize: '1.5rem', fontWeight: '600', color: '#166534', margin: 0 }}>
            Indicadores de Qualidade Recentes
          </h2>
        </div>
        ...
        {projetos.length > 0 ? (
          ...
          <div style={{
            ...
            Nenhum indicador de qualidade encontrado.
          </div>
        )}
      </div>
    </>
...
QualidadeScreen.displayName = 'QualidadeScreen';