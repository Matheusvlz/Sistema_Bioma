...
import {  Target, TrendingUp, CheckCircle, AlertTriangle, FlaskConical } from 'lucide-react';
...
export const FQScreen = memo<FQScreenProps>(({ projetos, estatisticas }) => {
  return (
    <>
      {/* Cards de Estatísticas para Físico-Química */}
      <div style={{
        display: 'grid',
      ...
      {/* Análises Recentes para Físico-Química */}
      <div style={modernCardStyle}>
        <div style={{ display: 'flex', alignItems: 'center', marginBottom: '1.5rem' }}>
          <FlaskConical size={24} color="#166534" style={{ marginRight: '0.75rem' }} />
          <h2 style={{ fontSize: '1.5rem', fontWeight: '600', color: '#166534', margin: 0 }}>
            Análises Físico-Químicas Recentes
          </h2>
        </div>
